...
因为共学的报名和打卡是基于 GitHub 进行开展的，如果你是非开发者或者对 git 操作不熟悉，请先阅读此文档：[残酷共学 GitHub 新手教程](https://www.notion.so/lxdao/GitHub-bd65b981146947fea1fb675942567a45)
...
- **Step05**：请加入共学群组保持交流（群组链接待定）。加入群组后请在群里报到一下方便助教记录
